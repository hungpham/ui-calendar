...
var Grid = fc.Grid = RowRenderer.extend({
	...
	headCellHtml: function(cell) {
		...
		return '' +
			...
			'</th>'+
			'<th class="fc-day-header fc-widget-header fc-mon fc-header-smk">' +
            	'<span class="fc-header-shift">SHIFT</span>' +
            	'<span class="fc-header-market">market</span>' + 
            '</th>';
	},
	...
	bgCellHtml: function(cell) {
		...
		return '<td class="' + classes.join(' ') + '"' +
			...
			'></td>' +
			'<td class="fc-smk-cell ' + classes.join(' ') + '" data-date="' + date.format() + '">' +
			'</td>';
	},
